...
assert(html.includes('games/sevens.js?v=0.8.1'),'Sevens definition is loaded');
assert(html.includes('games/war.js?v=0.8.1'),'War definition is loaded');
assert(html.includes('games/rummy.js?v=0.8.1'),'Rummy definition is loaded');
assert(html.includes('games/pan.js?v=0.8.1'),'Pan definition is loaded');
assert(html.includes('shedding-engine.js?v=0.8.1'),'shedding engine is loaded');
...
assert(html.includes('battle-engine.js?v=0.8.1'),'battle engine is loaded');
