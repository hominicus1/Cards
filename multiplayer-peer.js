(function(root,factory){
  ...
  class PeerTransport{
    constructor({PeerClass,onStatus=()=>{},onMessage=()=>{}}={}){
      this.PeerClass=PeerClass||globalThis.Peer;
      this.onStatus=onStatus;this.onMessage=onMessage;this.peer=null;this.connection=null;this.role=null;this.code='';
    }
    ...
    bindConnection(conn){
      ...
      conn.on('open',()=>{this.status('connected');this.send({type:'HELLO',protocol:1});});
