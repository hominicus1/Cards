...
assert(html.includes('games/sevens.js?v=0.8.2'),'Sevens definition is loaded');
assert(html.includes('games/war.js?v=0.8.2'),'War definition is loaded');
assert(html.includes('games/rummy.js?v=0.8.2'),'Rummy definition is loaded');
assert(html.includes('games/pan.js?v=0.8.2'),'Pan definition is loaded');
assert(html.includes('shedding-engine.js?v=0.8.2'),'shedding engine is loaded');
...
assert(html.includes('battle-engine.js?v=0.8.2'),'battle engine is loaded');
